...
export default function InstagramComponents() {
  return (
    <div>
      <div className="hidden relative mx-auto mt-48 h-[369px] w-[90%] rounded-lg bg-[#2171E8] p-4 bg-[url('/Group10.png')] bg-no-repeat bg-center lg:flex lg:flex-row  flex-col">
