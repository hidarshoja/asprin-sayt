...
export default function InstagramComponents() {
  return (
    <div>
      <div className="hidden relative mx-auto lg:mt-36  h-[369px]  bg-[#2171E8] p-4 bg-[url('/Group10.png')] bg-cover rounded-t-3xl bg-no-repeat bg-center lg:flex lg:flex-row  flex-col">
