...
export default function Experience() {
    ...
    switch (activeSection) {
      case "diagnosis":
        return (
          <div>
            <p>
              تغذیه مناسب: توجه به رژیم غذایی سالم و متعادل بسیار مهم بود. مشورت
              با یک متخصص تغذیه کمک زیادی به من کرد.
            </p>
            <p>
              حفظ روحیه: حفظ روحیه مثبت و متعادل چالش برانگیز بود، اما بسیار مهم
              است. من سعی کردم با مطالعه کتاب‌های انگیزشی و شرکت در جلسات
              مشاوره، روحم را حفظ کنم.
            </p>
            <p>
              حمایت عاطفی: داشتن یک شبکه حمایتی از خانواده و دوستان بسیار مهم
  ...
  return (
    <div className="w-full bg-white min-h-[1000px] py-3 px-3 lg:px-0 lg:py-0 lg:h-[600px]">
      <div className="flex flex-col lg:flex-row mt-32 items-center justify-between lg:px-20">
        <div className="w-full lg:w-1/3 text-[#35383f] text-[14px] lg:text-[30px] px-2  font-bold">
