...
export default function FindDoctorBox() {
  ...
  return (
   <>
        <div className="hidden lg:block w-full bg-white p-3 lg:px-6 lg:py-2 xl:py-6 2xl:py-10 rounded-lg shadow-md relative border border-[#E0E0E0] min-h-[320px]  lg:min-h-[365px]">
      ...
      <div className="flex absolute flex-col gap-1 left-[-14px] top-[40%]">
       ...
       <div className="block lg:hidden mt-4 lg:mt-10 overflow-hidden">
      ...
      <p className="text-[#424242]  w-full text-[12px] mt-2 lg:text-[16px] font-medium text-right">
        خدمات {currentDoctor.name}
      </p>
      <div className="flex items-center justify-start  gap-2">
        {currentDoctor.services.map((service, index) => (
          <span
            key={index}
            className="bg-[#fafafa] text-[#757575] flex items-center justify-center text-[11px] lg:text-[14px] font-normal px-[2px] py-2 overflow-hidden lg:py-3 lg:px-4 mt-3 rounded-[70px] border border-[#e0e0e0]"
          >
            {service}
          </span>
        ))}
